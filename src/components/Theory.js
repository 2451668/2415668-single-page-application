...
const Theory = () => {
  return (
    <div className={styles.container}>
      <h1>🌳 Theoretical Work and Essay content</h1>
      <br />
      ...
      by a handful of some I sourced online.</p>
      <br />
      <p>Emerging prominently in the early 1990s, net art utilizes the internet both as a medium 
      ...
      personally (Rush, 2005).</p>
      <br />
      <p>Before really getting into the theory behind net art, I had lumped in all digital art as 
      technically being ‘art on the net’; digital artworks, such as portraits created in Procreate 
      ...
      file format. These don’t feature the interactive and network-based aspects that make net 
      art (Greene, 2004).</p>
      <br />
      <p>Net art as a genre distinctly leverages the internet, not just as a hosting platform but as an 
      ...
      case study for this writing.</p>
      <br />
      <p>"Death Imitates Language" by Harm van den Dorpel is, I believe, a great exemplar of net 
      ...
      digital artworks and their capacity for real-time interaction and transformation.</p>
      <br />
      <p>It was launched in 2016 and uses a generative algorithm to create new artwork from a set 
      ...
      This use of blockchain, I believe, underscores a critical aspect of net art—its engagement 
      ...
      before, is a crucial feature of net art (Carrier, 2018; Hertzmann, 2018).</p>
      <br />
      <p>The evolving nature of the piece is a pivotal characteristic. Unlike traditional art, which 
      ...
      <br />
      <p>That was some exposition and context behind the piece, and in this section, I would like 
      to analyse the work specifically in the framework of net art as we covered it in our 
      theoretical content and a bit more generally in the context of net art more broadly.</p>
      <br />
      <p>As stated before, one of the defining features of Death Imitates Language is its 
      interactive nature, which aligns with Aaron Hertzmann’s discussion on the evolving role 
      ...
      Carrier discusses in terms of digital reproduction's impact on art’s authenticity and 
      uniqueness (Carrier, 2018). Van den Dorpel's approach—using algorithms that mimic 
      genetic selection—challenges traditional notions of creativity and authorship. The 
      ...
      won’t speak on the relevance of blockchain in the role of net art, as that is more of a  
      feature of this work in particular, but I will say that, in some form, it does engage with 
      today’s culture and broader discussions about copyright, ownership, or simply the “reproducibility of digital objects” (Carrier, 2018). Blockchain is one solution to the 
      problem with digital art—its ease of duplication and the consequent challenges to 
      establishing and maintaining value, even if the advents of cryptocurrencies and NFTs 
      have left a poor impression on the general public.</p>
      <br />
      <p>To take it in a different direction, I would like to spend a passage talking about my own 
      interpretation of two specific pieces of the collection, or the population as Dorpel has 
      labelled them on the site.</p>
      <br />
      <p>Above are Eve and Adam, respectively, and I chose these two in particular to talk about 
      ...
      for creation (Paul, 2003). In contrast, Adam could represent or encapsulate the interent’s 
      evolved state, featuring many layers of complexity and an aggregation of data, visuals, 
      and code reflecting contemporary digital life (Manovich, 2001).</p>
      <br />
      <p>Death Imitates Language, at least at the time it was released, could be seen as setting the 
      stage for a broader showcase of generative art, where the creative process is defined not 
      by the artist’s hand but by an algorithm's capacity to select, combine, and recontextualise. 
      The offspring emerging from the two progenitors are a testament to the algorithm’s role 
