  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <br />
        <p>This site is only my first step in really appreciating the greens, though I figure there are ways we could all aim to support that which supports us, namely:</p>
        <br />
        <ul>
