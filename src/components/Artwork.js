  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <br />
        <p>Even still, I wanted to retain the tree motif that has been present through my site, in whatever I did end up producing. This led to what I have now, which was much simpler to create as the code only handles transitioning static images in a stylised fashion. This was simple enough to code, with the other half of the work being drawing the illustrations themselves. In the end, it was a nice way to consolidate some coding practices with my own drawing abilities, even if less sophisticated than my prior, more lofty ideas, and stands as a better representation of what I am capable of making.</p>
